...
async function redirectToOkta(req, res, next) {
    ...
    res.redirect(`${globalThis.config.idpHost}/oauth2/v1/authorize?client_id=${clientId}&redirect_uri=${redirectUri}&response_type=code&scope=${scope}&state=${state}`)
}
...
module.exports = { createAuthToken, redirectToOkta,whoAmI, getGleanToken }