...
async function sendChat({ body, authToken, res }) {
    const axiosRequest = {
        method: 'POST',
        baseURL: config.host,
        url: PATHS.CHAT,
...
async function listChats({ authToken }) {
    const axiosRequest = {
        method: 'POST',
        baseURL: config.host,
        url: PATHS.CHAT_LIST,
...
async function getChat({ authToken, chatId }) {
    const axiosRequest = {
        method: 'POST',
        baseURL: config.host,
        url: PATHS.CHAT_GET,
...
module.exports = { sendChat, listChats, getChat, setConfig }