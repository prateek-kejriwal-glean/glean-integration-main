...
class GleanApis {
    ...
    constructor(host, bearerToken, globalToken) {
        this.host = host
        this.bearerToken = bearerToken
        this.globalToken = globalToken
        this.client = {}
        globalThis.log("Initialising Glean APIs with credentials", { host })
        this.initAllApis()
    }
    ...
    initApi(fileName) {
        ...
        module.setConfig({ host: this.host, bearerToken: this.bearerToken, globalToken: this.globalToken })
    ...
    initAllApis() {
        ...
        globalThis.log("Initialised Glean APIs with credentials", { host: this.host, bearerToken: this.bearerToken, globalToken: this.globalToken })
